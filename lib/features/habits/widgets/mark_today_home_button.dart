...
class MarkTodayHomeButton extends StatefulWidget {
  ...
  @override
  State<MarkTodayHomeButton> createState() => _MarkTodayHomeButtonState();
}

class _MarkTodayHomeButtonState extends State<MarkTodayHomeButton> with TickerProviderStateMixin {
