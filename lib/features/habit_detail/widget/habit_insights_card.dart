      ...
      child: Column(
        ...
        children: [
          ...
          LinearProgressIndicator(
            value: progress / 100,
            backgroundColor: Color(habit.colorCode).withValues(alpha: 0.2),
            valueColor: AlwaysStoppedAnimation<Color>(Color(habit.colorCode)),
          ),
          const SizedBox(height: 12),
          Row(
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      daysRemaining > 0 ? "$daysRemaining days to formation" : "Habit formed! 🎉",
                      style: TextStyle(
                        fontSize: 11,
